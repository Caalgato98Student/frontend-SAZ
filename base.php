...
$_sitioNombreBase = get_config('sitio_nombre') ?? 'Sociedad Astronómica de Zacatecas';
?>
<!doctype html>
<html lang="es" data-bs-theme="light">
  <head>
    ...
    <title><?= htmlspecialchars($pageTitle ?? $_sitioNombreBase) ?></title>
    <meta name="description" content="<?= htmlspecialchars($pageDescription ?? 'Portal de noticias y actividades de la ' . $_sitioNombreBase . '.') ?>">
    <!-- Bootstrap 5.3 -->
