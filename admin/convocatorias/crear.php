    ...
    <div class="col-lg-8">
      <div class="adm-card mb-3">
        ...
        <div>
          ...
          <textarea class="form-control tinymce-editor" id="contenido" name="contenido" rows="10" placeholder="Detalla los requisitos, bases y condiciones..."><?=htmlspecialchars($vals['contenido'])?></textarea>
        </div>
      </div>
      <div class="adm-card mb-3">
